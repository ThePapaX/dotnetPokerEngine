 ...
 private:
  ...
  class CallData {
   public:
    ...
    // with the gRPC runtime.
    CallData(Evaluator::AsyncService* service, ServerCompletionQueue* cq)
    ...
    void Proceed() {
      if (status_ == CREATE) {
        ...
        service_->Evaluate(&ctx_, &request_, &responder_, cq_, cq_,
                                  this);
   ...
   private:
    ...
    EvaluationResult reply_;

    // The means to get back to the client.
    ServerAsyncResponseWriter<EvaluationResult> responder_;
