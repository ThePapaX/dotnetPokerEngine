...
#define StdDeck_Suit_COUNT    4
    ...
    typedef uint32_t StdDeck_RankMask;
    ...
    typedef union {
        ...
        struct {
            /* There are multiple ways to define these fields.  We could pack the
               ...
               the field.
               I found that uint32_t was faster than uint16 on a lot of processors --
...
#endif
*/
    extern POKEREVAL_EXPORT uint8_t             nBitsTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t     topFiveCardsTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t       topFiveBitTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint8_t           topCardTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t           topBitTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t       topTwoBitsTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t      topFiveBitsTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint8_t          straightTable[StdDeck_N_RANKMASKS];
    /*
    #ifdef __cplusplus
    }
    #endif
    */
    extern POKEREVAL_EXPORT uint32_t  bottomFiveCardsTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint32_t  bottomFiveJokerTable[StdDeck_N_RANKMASKS];
    extern POKEREVAL_EXPORT uint8_t        bottomCardTable[StdDeck_N_RANKMASKS];
